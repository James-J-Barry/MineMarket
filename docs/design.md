...
**Options (`sim options`, M9):** writing one wheat call pays $4.20 covered by the wheat itself, $4.10 on cash, $3.40 on 192 oak logs and $3.00 on 1,500 (the design doc's done-when). Priced on week-long realized volatility blended with a long-run level and a smile, at-the-money options return about their price over 1,280 weeks (+1% calls, -5% puts on the money spent): insurance or a bet, not a free lunch. A farmer insuring each harvest with 90% puts keeps at least 83% of its week-earlier value, against 56% uninsured, for about half a percent.

**An investing player (`sim progression`, after M10):** a player who uses what they unlock (crate, then Floor sales at +30%, news trading at 1.2% a day on $2,000, savings in shares at 0.55% a day) reaches each tier 20-25% sooner than one who only gathers, but Tier 7 still takes about 310 hours against 40. Node costs grow about 2x a tier while the tools add tens of percent to income, not the 3-5x the balance section asks for. With Tier 3+ node costs at a tenth of today's, the investor lands near the targets (Tiers 3-6 at 10, 15, 24 and 39 hours; Tier 7 at 72). Balance is deferred (James).
